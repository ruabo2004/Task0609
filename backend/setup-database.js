...
async function setupDatabase() {
  ...
  try {
    ...
    const sampleSearches = [
      ['phòng đôi', 'room', '{}', 5, null, null, 'session123', '127.0.0.1', 'Mozilla/5.0'],
      ['homestay gần biển', 'room', '{"location":"near_beach"}', 3, null, null, 'session124', '127.0.0.1', 'Mozilla/5.0'],
      ['phòng gia đình', 'room', '{"guests":4}', 2, null, null, 'session125', '127.0.0.1', 'Mozilla/5.0']
    ];
